    ...
    <>
      ...
      <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:gap-4">
        ...
        <div className="relative w-full sm:w-auto">
          <select
            defaultValue="Tất cả"
            className="h-12 w-full min-w-38.5 appearance-none rounded-xl border border-neutral-300 bg-white px-4 pr-10 text-[14px] font-medium text-neutral-600 outline-none focus:border-indigo-300"
          >
