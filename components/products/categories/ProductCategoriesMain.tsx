...
export const ProductCategoriesMain = () => {
  return (
    <div className="w-full p-4 md:p-6 lg:p-8">
      <div className="rounded-2xl border border-neutral-200 bg-white p-4 md:p-6">
        <div className="space-y-2">
          <h1 className="text-3xl font-bold text-neutral-900">Danh mục sản phẩm</h1>
          <p className="text-[13px] text-neutral-500">Quản lý danh mục để tổ chức sản phẩm theo nhóm rõ ràng.</p>
        </div>
        ...
        <div className="mt-6 overflow-hidden rounded-xl border border-neutral-200">
          ...
          <div className="flex flex-col items-center justify-center px-4 py-12 md:py-16 lg:py-20">
            <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-indigo-50 text-indigo-600 md:h-20 md:w-20">
              <FolderTree size={38} strokeWidth={1.8} className="md:h-[42px] md:w-[42px]" />
            </div>
            <p className="text-center text-2xl font-semibold text-neutral-900 sm:text-3xl lg:text-[40px]">Chưa có danh mục nào</p>
            <p className="mt-2 max-w-2xl text-center text-[13px] text-neutral-500">Tạo danh mục đầu tiên để phân loại sản phẩm rõ ràng hơn.</p>
          </div>
        </div>
      </div>
    </div>
