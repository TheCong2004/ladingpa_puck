...
export const ProductCustomFieldsMain = () => {
  return (
    <div className="w-full p-4 md:p-6 lg:p-8">
      <div className="rounded-2xl border border-neutral-200 bg-white p-4 md:p-6">
        <div className="space-y-2">
          <h1 className="text-3xl font-bold text-neutral-900">Trường tùy chỉnh sản phẩm</h1>
          <p className="text-[13px] text-neutral-500">Quản lý các trường dữ liệu mở rộng cho từng sản phẩm.</p>
        </div>
        ...
        <div className="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-12 lg:gap-4">
          <label className="flex h-11 items-center gap-2 rounded-xl border border-neutral-200 px-3 sm:col-span-2 lg:col-span-8">
            ...
            <input
              type="text"
              placeholder="Tìm kiếm trường tùy chỉnh..."
        ...
        <div className="mt-6 overflow-hidden rounded-xl border border-neutral-200">
          <div className="hidden border-b border-neutral-200 bg-neutral-50 px-3 py-3 text-[13px] font-bold text-neutral-700 lg:grid lg:grid-cols-5">
            <span>Tên trường</span>
            <span>Loại dữ liệu</span>
            <span>Hiển thị ở</span>
            <span>Trạng thái</span>
            <span className="text-right">Ngày cập nhật</span>
          </div>
          <div className="grid grid-cols-2 gap-y-2 border-b border-neutral-200 bg-neutral-50 px-3 py-3 text-[13px] font-bold text-neutral-700 sm:grid-cols-3 lg:hidden">
            ...
            <span>Loại dữ liệu</span>
            <span>Trạng thái</span>
            <span className="col-span-2 sm:col-span-1">Ngày cập nhật</span>
          </div>
          ...
          <div className="flex flex-col items-center justify-center px-4 py-12 md:py-16 lg:py-20">
            <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-indigo-50 text-indigo-600 md:h-20 md:w-20">
              <SlidersHorizontal size={38} strokeWidth={1.8} className="md:h-[42px] md:w-[42px]" />
            </div>
            <p className="text-center text-2xl font-semibold text-neutral-900 sm:text-3xl lg:text-[40px]">Chưa có trường tùy chỉnh nào</p>
            <p className="mt-2 max-w-2xl text-center text-[13px] text-neutral-500">Tạo trường tùy chỉnh để lưu thêm thuộc tính linh hoạt cho sản phẩm.</p>
          </div>
        </div>
      </div>
    </div>
